...
# v02 --> Added in calcs for Eps_L/W, weighted mean, and error propagation 
#         Added in calcs for RI_BP, RI_GDGT, ring diffs, and ring enrichments
#         Added in option to remove treatments with no BP or isotope data
# v03 --> Remove all treatments and all replicates that don't have BP/ iso data
#         Remove all "Carbon" experiments from the enviro subset
# v04 --> Updated to work with "AllSaciExpData_v02.xlsx" 
#         removes RPM 200 from RPM exp
...
fracCurve_merge <- Water


#### Save as .csv and .RDS files ####
write.csv(all_merge, file = "00_Experiment Dataframes/all_merge.csv", 
          row.names = FALSE)
write.csv(enviro_merge, file = "00_Experiment Dataframes/enviro_merge.csv", 
          row.names = FALSE)
write.csv(fracCurve_merge, file = "00_Experiment Dataframes/fracCurve_merge.csv", 
          row.names = FALSE)
write.csv(Temp, file = "00_Experiment Dataframes/temp.csv", 
          row.names = FALSE)
write.csv(pH, file = "00_Experiment Dataframes/pH.csv", 
          row.names = FALSE)
write.csv(RPM, file = "00_Experiment Dataframes/RPM.csv", 
          row.names = FALSE)
write.csv(DO, file = "00_Experiment Dataframes/DO.csv", 
          row.names = FALSE)
write.csv(Flux, file = "00_Experiment Dataframes/flux.csv", 
          row.names = FALSE)
write.csv(Water, file = "00_Experiment Dataframes/water.csv", 
          row.names = FALSE)
# save as RDS files
...
saveRDS(fracCurve_merge, file = "00_Experiment Dataframes/fracCurve_merge.RDS")
